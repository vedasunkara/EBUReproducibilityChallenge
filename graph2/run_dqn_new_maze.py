...
if __name__ == "__main__":
    ...
    # mnist_maze(0.5,EBU=True,stochastic=True,display=False,EBU_VAL=0.25,trials=10)
    # mnist_maze(0.5,EBU=True,stochastic=True,display=False,EBU_VAL=0.5,trials=10)
    # mnist_maze(0.5,EBU=True,stochastic=True,display=False,EBU_VAL=0.75,trials=10)
    # mnist_maze(0.5,EBU=True,stochastic=True,display=False,EBU_VAL=1.0,trials=10)
    # mnist_maze(0.5,EBU=False,stochastic=True,display=False,trials=10)
    # mnist_maze(0.5,EBU=False,stochastic=True,display=False,NSTEP=True,trials=10)

    # mnist_maze(0.5,EBU=False,stochastic=False,display=False,trials=10)
    # mnist_maze(0.5,EBU=False,stochastic=False,display=False,NSTEP=True,trials=10)

    run_mnist_maze(0.2,EBU=True,stochastic=False,display=False,EBU_VAL=1.0,trials=0)
    run_mnist_maze(0.2,EBU=False,stochastic=False,display=False)
    run_mnist_maze(0.2,EBU=False,stochastic=False,display=False,NSTEP=True,trials=0)
    #mnist_maze(0.5,EBU=True,stochastic=False,display=False,EBU_VAL=1.0,trials=0)
    ...
    #mnist_maze(0.5,EBU=True,stochastic=True,display=False,trials=7,EBU_VAL=0.75)
    # mnist_maze(0.5,EBU=True,stochastic=True,display=False,trials=47,EBU_VAL=0.5)
    #mnist_maze(0.5,EBU=True,stochastic=True,display=False,trials=0,EBU_VAL=0.25)


    # mnist_maze(0.2,EBU=False,stochastic=False,display=False,trials=0,NSTEP=True)
    # mnist_maze(0.5,EBU=False,stochastic=False,display=False,trials=0,NSTEP=True)
    # mnist_maze(0.5,EBU=False,stochastic=True,display=False,trials=0,NSTEP=True)
