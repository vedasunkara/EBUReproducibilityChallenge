...
class DQNSolverEBU:
    def __init__(self, observation_space, action_space,memory_size,gamma,beta):
        self.gamma = gamma
    ...
    def experience_replay(self):
        ...
        if self.num_episodes >= 1:
            ...
            q_tilde_temp =  self.old_network.model(tf.convert_to_tensor(next_states,tf.float32)) 
